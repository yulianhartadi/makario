    ...
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            if ($this->login_user->user_type == "staff" && $can_edit_tasks) {
                echo modal_anchor(get_uri("labels/modal_form"), "<i class='fa fa-tags'></i> " . lang('manage_labels'), array("class" => "btn btn-default", "title" => lang('manage_labels'), "data-post-type" => "task"));
...
<script type="text/javascript">
    ...
    source: '<?php echo_uri("projects/tasks_list_data/" . $project_id) ?>',
            ...
            {visible: false, searchable: false},
                    ...
                    {title: '<?php echo lang("milestone") ?>', visible: showResponsiveOption},
            {visible: false, searchable: false},
            {visible: false, searchable: false},
            {visible: false, searchable: false},

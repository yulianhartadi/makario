        ...
        <div  class="list-group-item"> 
            <div class="clearfix">
                ...
                <span class="pull-right"><?php
                    echo modal_anchor(get_uri("projects/stop_timer_modal_form/" . $timer->project_id), "<i class='fa fa fa-clock-o'></i> " . lang('stop_timer'), array("class" => "btn btn-danger btn-sm", "title" => lang('stop_timer'), "data-post-task_id" => $timer->task_id));
                    ?>
                </span>
            </div>

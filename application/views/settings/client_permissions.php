            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body"> 
                    ...
                    <div id="verify_email_before_client_signup_area" class="form-group <?php echo get_setting("disable_client_signup") ? "hide" : "" ?>">
                        <label for="verify_email_before_client_signup" class="col-md-2"><?php echo lang('verify_email_before_client_signup'); ?></label>
                        <div class="col-md-10">
                            <?php
                            echo form_checkbox("verify_email_before_client_signup", "1", get_setting("verify_email_before_client_signup") ? true : false, "id='verify_email_before_client_signup' class='ml15'");
                            ?>                       
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="client_can_delete_own_files_in_project" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('client_can_delete_own_files_in_project'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                            echo form_checkbox("client_can_delete_own_files_in_project", "1", get_setting("client_can_delete_own_files_in_project") ? true : false, "id='client_can_delete_own_files_in_project' class='ml15'");
                            ?>                       
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="disable_access_favorite_project_option_for_clients" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('disable_access_favorite_project_option_for_clients'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                            echo form_checkbox("disable_access_favorite_project_option_for_clients", "1", get_setting("disable_access_favorite_project_option_for_clients") ? true : false, "id='disable_access_favorite_project_option_for_clients' class='ml15'");
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="disable_dashboard_customization_by_clients" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('disable_dashboard_customization_by_clients'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                            echo form_checkbox("disable_dashboard_customization_by_clients", "1", get_setting("disable_dashboard_customization_by_clients") ? true : false, "id='disable_dashboard_customization_by_clients' class='ml15'");
                            ?>
                        </div>
                    </div>

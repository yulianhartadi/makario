...
<div class="modal-body clearfix">
    ...
    <?php if ($related_to === "clients" || $related_to === "client_contacts" || $related_to === "projects" || $related_to === "tasks" || $related_to === "tickets" || $related_to === "invoices" || $related_to === "estimates" || $related_to === "timesheets") { ?>
    ...
    <?php if ($related_to === "leads") { ?>
        <div class="form-group">
            <label for="show_on_kanban_card" class=" col-md-3"><?php echo lang('show_on_kanban_card'); ?></label>
            <div class="col-md-9">
                <?php
                echo form_checkbox(
                        "show_on_kanban_card", "1", $model_info->show_on_kanban_card, "id='show_on_kanban_card'"
                );
                ?>
            </div>
        </div>

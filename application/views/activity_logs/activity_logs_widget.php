        ...
        <div class="media b-b mb15">
            ...
            <div class="media-body">
                ...
                <?php if ($log->action === "bitbucket_notification_received" || $log->action === "github_notification_received") { ?>
                    <p> <?php echo lang($log->log_type) . ": " . modal_anchor(get_uri("projects/task_view"), " #" . $log->log_type_id . " - " . convert_mentions($log->log_type_title), array("title" => lang('task_info') . " #$log->log_type_id", "class" => "dark", "data-post-id" => $log->log_type_id)); ?></p>
                <?php } ?>

...
(function ($) {
    ...
    $.fn.appTable = function (options) {
        ...
        var defaults = {
            ...
            responsive: ((AppHelper.settings.disableResponsiveDataTableForMobile !== "1") && (window.outerWidth < 800)) ? true : false, //by default, apply the responsive design only on the mobile view
...
(function ($) {
    $.fn.appModifier = function (options) {
        ...
        $("div#custom-popover-submit-btn-" + tempId).click(function () {
            initAjaxAction($instance, ($inputField.val() ? $inputField.val() : settings.value), settings);
        });
